    ...
    return (
        <div className="flex flex-col">
            ...
            <div className="flex w-full justify-center p-4 pt-24 pb-8 m-auto">
                ...
                <div className="flex w-11/12 max-w-6xl justify-center items-center text-center z-20">
                    <div className="hidden lg:block lg:mr-20 lg:ml-4 lg:max-w-md md:hidden">
                    ...
                    <div className="flex flex-col space-y-8 max-w-lg mr-8">
                        ...
                        <p className="leading-loose text-stone-400">
                            LeetCloned is the best platform to help you enhance
            ...
            <div
                ...
                id="explore"
            >
                <div className="flex w-11/12 max-w-6xl justify-center ">
                    <div className="flex flex-col space-y-5 max-w-lg mt-10 ml-14">
                        ...
                        <p className="leading-loose text-stone-400">
                            Explore is a well-organized tool that helps you get
                            the most out of LeetCloned by providing structure to
                            guide your progress towards the next step in your
                            programming career.
                        </p>
            ...
            {/* Product */}
            <div
                className="flex w-full justify-center p-4 pb-6 m-auto"
                id="product"
            >
                ...
                <div className="lg:flex lg:flex-row w-11/12 max-w-6xl lg:justify-between lg:text-left z-20 md:flex md:flex-col">
                    <div className="flex flex-col space-y-5 max-w-lg mt-5 ml-5">
                        ...
                        <p className="leading-loose text-stone-400">
                            Over 2900 questions for you to practice. Come and
                            join one of the largest tech communities with
                            hundreds of thousands of active users and
                            participate in our contests to challenge yourself
                            and earn <br></br> rewards.
                        </p>
                    ...
                    <div className="border-l-[2px] border-white lg:w-1/2">
                        <div className="flex flex-col space-y-5 max-w-lg my-5 ml-14">
                            ...
                            <p className="leading-loose text-stone-400">
                                Not only does LeetCloned prepare candidates for
                                technical interviews, we also help companies
                                identify top technical talent. From sponsoring
                                contests to providing online assessments and
                                training, we offer numerous services to
                                businesses.
                            </p>
                            <button className="text-[#0088cc] hover:text-[#53C2FF] rounded-full mr-auto flex items-center justify-center">
                ...
                <div className="flex w-11/12 max-w-6xl justify-center text-center">
                    <div className="flex flex-col space-y-5 max-w-[940px] mt-14">
                        ...
                        <p className="leading-loose max-w-xl text-stone-400 mx-auto">
                            ...
                            core, LeetCloned is about developers. Our powerful
            ...
            <div className="flex w-full justify-center p-4 pb-10 m-auto z-20 bg-white">
                <div className="flex flex-col w-11/12 max-w-6xl justify-center text-center items-center mt-[-101px]">
                    <div className="flex flex-col space-y-5 max-w-[600px] mt-14">
                        ...
                        <p className="leading-loose text-stone-400">
                            At LeetCode, our mission is to help you improve
                            yourself and land your dream job. We have a sizable
                            repository of interview resources for many
                            companies. In the past few years, our users have
                            landed jobs at top companies around the world.
                        </p>
                    </div>
                ...
                <div className="flex w-11/12 max-w-6xl justify-center text-center">
                    <div className="flex flex-col space-y-5 max-w-xl mb-12">
                        <p className="leading-loose text-stone-400 border-t-[1px] border-[#dddddd] pt-[70px]">
                            If you are passionate about tackling some of the
                            most interesting problems around, we would love to
                            hear from you.
                        </p>
